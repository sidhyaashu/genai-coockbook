...
config = LiveConnectConfig(
    ...
    system_instruction="You are a helpful assistant. Please respond to user queries in simple word and try to give short answer.",
)

class LiveAPIWebSocketServer(BaseWebSoketServer):
