...
async def gemini_session_handler(websocket: websockets.ClientConnection):
                            ...
                            if "realtime_input" in data:
                                for chunk in data["realtime_input"]["media_chunks"]:
                                    if chunk["mime_type"] == "audio/pcm":
                                        ...
                                        image_data = base64.b64decode(chunk["data"])  # Decode base64
                                        image = Image.open(BytesIO(image_data)) 
                                        # await session.send_realtime_input(input={
